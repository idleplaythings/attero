...
var TileTexture = function(args, effects)
{
    this.id = args.id;
    this.img = args.img;
    this.underShadow = false;
    this.concealment = args.concealment || 0;
    this.brush = args.brush.split(',');
...
TileTexture.prototype = {

	constructor: TileTexture,

    getRandomMask: function()
    {
        var l = this.brush.length;
        return this.brush[(Math.floor(Math.random()*l))];
    },
...
var BorderTexture = function(id, img, brush, borderRGB, concealment)
{
    Texture.call( this, id, img, brush, concealment);
...
var WaterTexture = function(id, img, brush, borderRGB)
{
    Texture.call( this, id, img, brush );
    this.borderRGB = borderRGB;
}
